...
INTRA_LOGIN_REDIRECT_URI = f"http://{SERVER_DOMAIN}:{SERVER_PORT}/oauth2/intra/callback/login/"
INTRA_LINK_REDIRECT_URI = f"http://{SERVER_DOMAIN}:{SERVER_PORT}/oauth2/intra/callback/link/"
INTRA_REDIRECT_URI = f"http://{SERVER_DOMAIN}:{SERVER_PORT}/oauth2/intra/callback/"

CLIENT_INTRA_REDIRECT_LOGIN = f"http://{CLIENT_DOMAIN}:{CLIENT_PORT}/login"
CLIENT_INTRA_REDIRECT_LINK = f"http://{CLIENT_DOMAIN}:{CLIENT_PORT}/userinfo"
