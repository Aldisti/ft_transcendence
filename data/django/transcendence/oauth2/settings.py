...
GOOGLE_LOGIN_REDIRECT_URI = f"{SERVER_PROTOCOL}://{SERVER_DOMAIN}:{SERVER_PORT}/oauth2/google/callback/login/"
GOOGLE_LINK_REDIRECT_URI = f"{SERVER_PROTOCOL}://{SERVER_DOMAIN}:{SERVER_PORT}/oauth2/google/callback/link/"
