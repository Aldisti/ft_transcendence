...
GOOGLE_LOGIN_REDIRECT_URI = f"{SERVER_PROTOCOL}://{SERVER_DOMAIN}:{SERVER_PORT}/oauth2/google/v1/callback/login/"
GOOGLE_LINK_REDIRECT_URI = f"{SERVER_PROTOCOL}://{SERVER_DOMAIN}:{SERVER_PORT}/oauth2/google/v1/callback/link/"
GOOGLE_REDIRECT_URI = f"{SERVER_PROTOCOL}://{SERVER_DOMAIN}:{SERVER_PORT}/oauth2/google/callback/"


# Client redirects

CLIENT_REDIRECT_LOGIN = f"{CLIENT_PROTOCOL}://{CLIENT_DOMAIN}:{CLIENT_PORT}/login"
CLIENT_REDIRECT_LINK = f"{CLIENT_PROTOCOL}://{CLIENT_DOMAIN}:{CLIENT_PORT}/userinfo"
