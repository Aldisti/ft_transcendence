...
export const socket = {
    CHAT_SOCKET: `${ws_protocol}://${ip}:${port}/ws/chat/socket/`,
    NOTIFICATION_SOCKET: `${ws_protocol}://${ip}:${port}/ws/notification/socket/`,
    GET_TICKET: `${protocol}://${ip}:${port}/auth/ticket/`,

    GET_QUEQUE_TICKET: `${protocol}://${ip}:${port}/auth/ticket/matchmaking/`,
    GAME_SOCKET: `${ws_protocol}://${ip}:${pongPort}/ws/game/socket/`,
    QUEUE_SOCKET: `${ws_protocol}://${ip}:${pongPort}/ws/matchmaking/queue/`
}
